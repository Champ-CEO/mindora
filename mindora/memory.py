...
from mindora.data import create_db_connection
from mindora.models import create_embeddings
...
class MemoryManager:
    ...
    def retrieve_memories(self, query: str, user_id: str, k: int = 5) -> List[Memory]:
        ...
        documents = self.vector_store.similarity_search(query, k=k, filter=filter_function)
